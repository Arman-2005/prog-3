...
class Predater {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 15) {
            ...
            var predater = new Predater(newX, newY);
...
class Tarakan {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 15) {
            ...
            var tarakan = new Tarakan(newX, newY);
            tarakanArr.push(tarakan);
            this.multiply = 0;
        }
    }
    ...
    die() {
        ...
        for (var i in tarakanArr) {
            if (this.x == tarakanArr[i].x && this.y == tarakanArr[i].y) {
                tarakanArr.splice(i, 1);
                break;
            }
        }
    }
